  ...
  return (
    <div className="w-full mt-10">
      ...
      <div className="w-3/4 flex flex-col items-center mx-auto mt-16">
        <div>
          <h4 className="text-2xl font-semibold leading-7 text-white">Informacje o ZS10</h4>
          <p className="mt-1 text-base max-w-2xl leading-6 text-gray-400">Zespół Szkół nr. 10 w Warszawie im. Stansiława Staszica</p>
        </div>
        <div className="flex flex-col items-center gap-3 mt-28">
          <Button className="border-b text-xl border-gray-300 text-gray-300 flex flex-row gap-2 items-center" target="_blank" href="https://zs10.pl">
          ...
          <Button className="border-b text-xl border-gray-300 text-gray-300 flex flex-row gap-2 items-center" target="_blank" href="https://www.facebook.com/SamorzadZS10">
